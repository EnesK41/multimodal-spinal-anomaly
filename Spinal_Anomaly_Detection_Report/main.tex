...
\title{Multimodal Spinal Anomaly Detection from X-ray Images Supported by CT}
\author{Enes Korkmaz}
...
%% {project acceptance date}{jury members excluding supervisor}
%% Note that jury members should be comma separated.
\makejury{26 February 2026}{Doç. Dr. Yakup Genç}
